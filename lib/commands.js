...
│✿ *ᴅᴇᴠᴇʟᴏᴘᴇʀ ::* $owner
│ꕥ *ᴛʏᴘᴇ ::* $botType
│⸙ *𝚌𝚊𝚗𝚊𝚕 𝚘𝚏𝚒𝚌𝚒𝚊𝚕 ::* https://whatsapp.com/channel/0029Vaz6RTR0LKZIKwudX32x
│⚘ *sʏsᴛᴇᴍ/ᴏᴘʀ ::* $device
│○ *ᴛɪᴍᴇ ::* $tiempo, $tempo
│𓏸 *ᴜsᴇʀs ::* $users
...
ꕤ *antilinks » #antienlaces* + <on|off>
...
ꕤ *$prefixxnxx* + _<query|url>_
> Buscar y descarga videos de XNXX.
ꕤ *$prefixxvideos* + _<query|url>_
> Buscar y descarga videos de XVideos.
ꕤ *$prefixdanbooru » $prefixdbooru* + _<tag>_
> Buscar imágenes en Danbooru.
ꕤ *$prefixgelbooru » $prefixgbooru* + _<tag>_
> Buscar imágenes en Gelbooru.
ꕤ *$prefixrule34 » $prefixr34* + _<tag>_
> Buscar imagenes en Rule34.
ꕤ *$prefixblowjob » $prefixbj* + _<mention>_
> Dar una mamada.
ꕤ *$prefixboobjob* + _<mention>_
> Hacer una rusa.
ꕤ *$prefixcum* + _<mention>_
> Venirse en alguien.
ꕤ *$prefixcummouth* + _<mencion>_
> Acabar en la boca de alguien.
ꕤ *$prefixcumshot* + _<mencion>_
> Disparar semen.
ꕤ *$prefixfap » $prefixpaja* + _<mention>_
> Hacerse una paja.
ꕤ *$prefixanal* + _<mention>_
> Hacer un anal.
ꕤ *$prefixgrabboobs* + _<mention>_
> Agarrar tetas.
ꕤ *$prefixfootjob* + _<mention>_
> Hacer una paja con los pies.
ꕤ *$prefixgrope* + _<mention>_
> Manosear a alguien.
ꕤ *$prefixundress » $prefixencuerar* + _<mention>_
> Desnudar a alguien.
ꕤ *$prefixsixnine » $prefix69* + _<mention>_
> Haz un 69 con alguien.
ꕤ *$prefixhandjob* + _<mencion>_
> Hacer una paja.
ꕤ *$prefixlickass* + _<mencion>_
> Lamer un culo.
ꕤ *$prefixlickdick* + _<mencion>_
> Lamer un pene.
ꕤ *$prefixlickpussy* + _<mention>_
> Lamer un coño.
ꕤ *$prefixspank » $prefixnalgada* + _<mention>_
> Dar una nalgada.
ꕤ *$prefixfuck » $prefixcoger* + _<mention>_
> Follarte a alguien.
ꕤ *$prefixsuckboobs* + _<mention>_
> Chupar tetas.
╰ׅ͜─֟͜─͜─ٞ͜─͜─๊͜─͜─๋͜─⃔═̶፝֟͜═̶⃔─๋͜─͜─͜─๊͜─ٞ͜─͜─֟͜┈ࠢ͜╯ׅ`,
